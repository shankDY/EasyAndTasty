...
import com.shank.eat.screens.other.recipes.IngredientsRecipeAdapter
import kotlinx.android.synthetic.main.fragment_recipe.*

class FavoriteRecipeFragment : BaseFragment(){
    private lateinit var mViewModel: FavoriteRecipeViewModel
    ...
    companion object {
        const val TAG = "FavoriteRecipeFragment"
    }
}